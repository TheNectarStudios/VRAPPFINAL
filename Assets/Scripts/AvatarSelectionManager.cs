...
public class AvatarSelectionManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(MultiplayerConstants.AVATAR_SELECTION_NUMBER, out storedAvatarSelectionNumber))
        {
...
// {
//     public const string AVATAR_SELECTION_NUMBER = "AvatarSelectionNumber";
...
// }
    ...
    private void LoadAvatarModelAt(int avatarIndex)
    {
        ...
        ExitGames.Client.Photon.Hashtable playerSelectionProp = new ExitGames.Client.Photon.Hashtable() { {MultiplayerConstants.AVATAR_SELECTION_NUMBER,avatarSelectionNumber } };
