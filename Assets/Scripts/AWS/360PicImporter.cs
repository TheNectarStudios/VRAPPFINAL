...
{
    public string relativeImagesDirectory = @"123\RamanNivas\NepaliVilla\PanaromaImages"; // Relative path to your images directory within the persistent data path
    ...
    void Start()
    {
        ...
        string imagesDirectory = Path.Combine(Application.persistentDataPath, relativeImagesDirectory);
